    ...
    <div className="page">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="form-grid">
          ...
          <input name="Creatinine_Level" placeholder="Creatinine" onChange={handleChange} required />
          <input name="BUN" placeholder="BUN" onChange={handleChange} required />
          <input name="GFR" placeholder="GFR" onChange={handleChange} required />
          <input name="Urine_Output" placeholder="Urine Output" onChange={handleChange} required />
